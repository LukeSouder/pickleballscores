import unittest
from team_states import Teams, Team1Server1, Team1Server2, Team2Server1, Team2Server2
...
class TestWinner(unittest.TestCase):
    ...
    #     self.assertEqual(Team2Server2(14, 16).winner(), 2)
    x = Teams(11, 8)
    print(type(x),x.__class__.__mro__)
    # def test_no_winner(self):
    #     self.assertEqual(Team1Server1(10, 10).winner(), 0)
    #     self.assertEqual(Team2Server2(11, 10).winner(), 0)
